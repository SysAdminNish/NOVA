...
interface SipGlossaryProps {
  standalone?: boolean;
}

export default function SipGlossary({ standalone }: SipGlossaryProps) {
  if (standalone) {
    return (
      <div className="px-6 py-5 max-w-[900px] mx-auto">
        <div className="flex items-center gap-3 mb-6">
          <BookOpen size={18} className="text-cyan" />
          <h1 className="text-base font-bold text-[var(--text-primary)]">SIP Glossary</h1>
        </div>
